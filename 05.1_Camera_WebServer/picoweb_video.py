...
#SSID = "iPhone (83)"         # Enter your WiFi name
#PASSWORD = "1234qwe@"     # Enter your WiFi password
SSID = "skybluem"         # Enter your WiFi name
PASSWORD = "abcd!@#$defg%^&*"     # Enter your WiFi password
